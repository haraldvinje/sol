...
//		};
        ...
        return new VertexArray( vertices, normals, colors, indices );
    }

    private static VertexArray createCircleColored(float radius, int sides, float[] colors) {
    ...
    public static VertexArray createCircleSinglecolor(float radius, int sides, float[] color) {
    ...
    public static VertexArray createCircleTwocolor(float radius, int sides) {
        int colorsLength = (1+sides)*3;
        float[] colors = new float[colorsLength];
    ...
    public static VertexArray createCircleMulticolor(float radius, int sides) {
        int colorsLength = (1+sides)*3;
        int vertexCount = sides+1;
        float[] colors = new float[colorsLength];
    ...
    public static VertexArray createCircle2c(float radius, int sides) {
        return createCircleTwocolor(radius, sides);
    }



    private static void putThreeFloat(float[] array, int startIndex, float v1, float v2, float v3) {
        array[startIndex] = v1;
        array[startIndex +1] = v2;
        array[startIndex +2] = v3;
    }
    private static void putThreeFloat(float[] array, int startIndex, float[] values) {
    ...
    private static void putThreeByte(byte[] array, int startIndex, byte v1, byte v2, byte v3) {
        array[startIndex] = v1;
        array[startIndex +1] = v2;
        array[startIndex +2] = v3;
    }
    private static void putThreeByte(byte[] array, int startIndex, int v1, int v2, int v3) {
